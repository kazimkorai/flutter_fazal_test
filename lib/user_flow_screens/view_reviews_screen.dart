...
class ViewReviewsScreen extends StatefulWidget {
  ...
  ViewReviewsScreen(this.useridFromApi);
  final String useridFromApi;
  @override
  _ViewReviewsScreenState createState() => _ViewReviewsScreenState(useridFromApi);
}

class _ViewReviewsScreenState extends State<ViewReviewsScreen> {
  _ViewReviewsScreenState(this.useridFromApi);
  final String useridFromApi;
  ...
  Widget build(BuildContext context) {
    GenericClasses.WidgetScreen = SingleEstablishmentScreen('');
