...
class SingleEstablishmentScreen extends StatefulWidget {

  SingleEstablishmentScreen(this.titleText);
  final String titleText;

  @override
  _SingleEstablishmentScreenState createState() =>
      _SingleEstablishmentScreenState(titleText);
}

class _SingleEstablishmentScreenState extends State<SingleEstablishmentScreen> {
  _SingleEstablishmentScreenState(this.titleText);
  final String titleText;
  double _rating = 0.0;
  ...
  Widget build(BuildContext context) {
    GenericClasses.WidgetScreen = SubCategoryScreen(titleText);
    ...
    return WillPopScope(
      onWillPop: () {
        return Navigator.pushReplacement(
            context,
            PageTransition(
                type: PageTransitionType.leftToRight, child: SubCategoryScreen(titleText)));
      },
      child: SafeArea(
        child: Scaffold(
                          ...
                          onTap: () {
                            Navigator.pushReplacement(
                                ...
                                PageTransition(
                                    ...
                                    child: ViewReviewsScreen(useridFromApi)));
                          },
                          child: Container(
