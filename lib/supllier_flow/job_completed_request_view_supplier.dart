...
class JobCompletedRequestViewSupplier extends StatefulWidget {
  @override
  _JobCompletedRequestViewSupplierState createState() => _JobCompletedRequestViewSupplierState();
}

class _JobCompletedRequestViewSupplierState extends State<JobCompletedRequestViewSupplier> {
    ...
    return WillPopScope(
      onWillPop: () {
        return Navigator.pushReplacement(
            context,
            PageTransition(
                type: PageTransitionType.leftToRight, child: SupplierNewRequestScreen()));
      },
      child: SafeArea(
        child: Scaffold(
