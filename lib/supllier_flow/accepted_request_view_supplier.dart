...
class AcceptedRequestViewSupplier extends StatefulWidget {
  @override
  _AcceptedRequestViewSupplierState createState() => _AcceptedRequestViewSupplierState();
}

class _AcceptedRequestViewSupplierState extends State<AcceptedRequestViewSupplier> {
