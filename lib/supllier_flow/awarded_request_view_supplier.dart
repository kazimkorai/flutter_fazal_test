...
class AwardedRequestViewSupplier extends StatefulWidget {
  @override
  _AwardedRequestViewSupplierState createState() => _AwardedRequestViewSupplierState();
}

class _AwardedRequestViewSupplierState extends State<AwardedRequestViewSupplier> {
