...
//     favoriteVenues: List<FavoriteVenue>.from(json["favoriteVenues"].map((x) => FavoriteVenue.fromJson(x))),
//     userLocations: List<UserLocation>.from(json["userLocations"].map((x) => UserLocation.fromJson(x))),
//   );
//
//   Map<String, dynamic> toJson() => {
...
//     "favoriteVenues": List<dynamic>.from(favoriteVenues.map((x) => x.toJson())),
//     "userLocations": List<dynamic>.from(userLocations.map((x) => x.toJson())),
//   };
// }
//
// class FavoriteVenue {
